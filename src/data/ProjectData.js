...
export const ProjectList = [

  {
    ...
    title: "Shh Party! ",
    description:
      "An android app for synchronized music playback on an ad-hoc network with chat features! Party in Silence!",
    tech_stack: ["Android"],
    github_url: "https://github.com/ashwin-sridhar/ShhParty",
    demo_url: "",
  },
  {
    video: "/bhairav.mp4",
    title: "Hello, Bhairav!",
    description:
    "An arduino based robotic dog, Bhairav and an android app to talk to Bhairav. Built for tail clan (formerly Tales with Tails 269). Bhairav functions as an important tool in mental health/ Animal-Assisted Therapy realm.",
